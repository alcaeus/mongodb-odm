...
final class DocumentPersister
{
    ...
    /** @phpstan-var ShardKeyQueryBuilder<T> */
    private ShardKeyQueryBuilder $shardKeyQueryBuilder;

    /** @phpstan-var DocumentLoader<T> */
    ...
    public function __construct(
        ...
        $this->shardKeyQueryBuilder = new ShardKeyQueryBuilder($this->dm, $this->uow, $this->class, $this->criteriaPreparer);
        ...
        $this->documentLoader = new DocumentLoader($this->dm, $this->uow, $this->hydratorFactory, $this->class, $this->criteriaPreparer, $this->shardKeyQueryBuilder, $this->collection);
    }
    ...
    {
        $options['upsert'] = true;
        $criteria          = $this->shardKeyQueryBuilder->getQueryForDocument($document);
