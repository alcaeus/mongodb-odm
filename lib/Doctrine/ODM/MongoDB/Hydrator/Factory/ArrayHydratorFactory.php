...
class ArrayHydratorFactory implements Factory, TypeMapHydrator
{
     ...
     *
     * @psalm-var array<class-string, ArrayHydrator>
     */
     ...
     */
    public function getHydratorFor(string $className): ArrayHydrator
    {
    ...
    {
        try {
            // Attempte to create the hydrator
            $this->getHydratorFor($className);
 ...
 */
class $hydratorClassName extends ArrayHydrator
{
